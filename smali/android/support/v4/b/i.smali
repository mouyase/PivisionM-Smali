...
.method public constructor <init>(Landroid/support/v4/b/h;)V
    ...
    iput-object v1, p0, Landroid/support/v4/b/i;->a:[I
    ...
    .line 58
    iget-object v4, p0, Landroid/support/v4/b/i;->a:[I

    add-int/lit8 v5, v1, 0x1

    iget v6, v0, Landroid/support/v4/b/h$a;->a:I
    ...
    iget v1, v1, Landroid/support/v4/b/r;->mIndex:I
    ...
    iget v6, v0, Landroid/support/v4/b/h$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/b/h$a;->e:I
...
# virtual methods
.method public a(Landroid/support/v4/b/x;)Landroid/support/v4/b/h;
    .locals 8
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/b/h;-><init>(Landroid/support/v4/b/x;)V

    move v1, v0

    .line 97
    :goto_0
    iget-object v2, p0, Landroid/support/v4/b/i;->a:[I
    ...
    .line 98
    new-instance v4, Landroid/support/v4/b/h$a;

    invoke-direct {v4}, Landroid/support/v4/b/h$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/b/h$a;->a:I
    ...
    iget-object v6, p0, Landroid/support/v4/b/i;->a:[I
    ...
    .line 104
    iget-object v5, p1, Landroid/support/v4/b/x;->e:Ljava/util/ArrayList;
    ...
    .line 105
    iput-object v0, v4, Landroid/support/v4/b/h$a;->b:Landroid/support/v4/b/r;
    ...
    iput v0, v4, Landroid/support/v4/b/h$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/b/h$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/b/h$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/b/h$a;->f:I

    .line 113
    iget v0, v4, Landroid/support/v4/b/h$a;->c:I

    iput v0, v3, Landroid/support/v4/b/h;->d:I

    .line 114
    iget v0, v4, Landroid/support/v4/b/h$a;->d:I

    iput v0, v3, Landroid/support/v4/b/h;->e:I

    .line 115
    iget v0, v4, Landroid/support/v4/b/h$a;->e:I

    iput v0, v3, Landroid/support/v4/b/h;->f:I

    .line 116
    iget v0, v4, Landroid/support/v4/b/h$a;->f:I

    iput v0, v3, Landroid/support/v4/b/h;->g:I

    .line 117
    invoke-virtual {v3, v4}, Landroid/support/v4/b/h;->a(Landroid/support/v4/b/h$a;)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 146
    iget-object v1, p0, Landroid/support/v4/b/i;->d:Ljava/lang/String;

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 147
    iget v1, p0, Landroid/support/v4/b/i;->e:I
    ...
    .line 149
    iget-object v1, p0, Landroid/support/v4/b/i;->g:Ljava/lang/CharSequence;

    invoke-static {v1, p1, v0}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    .line 150
    iget v1, p0, Landroid/support/v4/b/i;->h:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 151
    iget-object v1, p0, Landroid/support/v4/b/i;->i:Ljava/lang/CharSequence;

    invoke-static {v1, p1, v0}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    .line 152
    iget-object v1, p0, Landroid/support/v4/b/i;->j:Ljava/util/ArrayList;

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    .line 153
    iget-object v1, p0, Landroid/support/v4/b/i;->k:Ljava/util/ArrayList;

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    .line 154
    iget-boolean v1, p0, Landroid/support/v4/b/i;->l:Z
