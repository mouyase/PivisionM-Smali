...
.field private final k:Landroid/support/v4/widget/ah;

.field private final l:Landroid/support/v4/widget/ah;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/ah;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ah$a;)Landroid/support/v4/widget/ah;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/ah;->a(I)V

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/ah;->a(F)V

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$i;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$i;->a(Landroid/support/v4/widget/ah;)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/ah;->a(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/widget/DrawerLayout$i;->a(Landroid/support/v4/widget/ah;)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;
    ...
    .line 638
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;
...
.method a(IILandroid/view/View;)V
    ...
    .line 804
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Landroid/support/v4/widget/ah;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/ah;
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v10, v6}, Landroid/support/v4/view/ai;->f(Landroid/view/View;F)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1918
    invoke-virtual {p1}, Landroid/support/v4/widget/DrawerLayout$h;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1933
    :cond_4
    iget v0, p1, Landroid/support/v4/widget/DrawerLayout$h;->d:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput v0, v6, Landroid/support/v4/widget/DrawerLayout$h;->d:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ah;
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/ai;->f(Landroid/view/View;F)V
