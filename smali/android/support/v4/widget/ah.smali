...
.field private final r:Landroid/support/v4/widget/ah$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v4/widget/ah$1;-><init>()V
...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/ah$a;)V
    .locals 3
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/ah$2;-><init>(Landroid/support/v4/widget/ah;)V
    ...
    .line 385
    iput-object p3, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/ah;->q:Landroid/support/v4/widget/x;
...
.method private a(Landroid/view/View;IIII)I
    ...
    .line 621
    :goto_1
    iget-object v4, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/ah$a;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;)I
...
.method public static a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ah$a;)Landroid/support/v4/widget/ah;
    .locals 3

    .prologue
    .line 363
    invoke-static {p0, p2}, Landroid/support/v4/widget/ah;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/ah$a;)Landroid/support/v4/widget/ah;
...
.method public static a(Landroid/view/ViewGroup;Landroid/support/v4/widget/ah$a;)Landroid/support/v4/widget/ah;
    .locals 2
    ...
    invoke-direct {v0, v1, p0, p1}, Landroid/support/v4/widget/ah;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/ah$a;)V
...
.method private a(FF)V
    ...
    .line 770
    iget-object v0, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    iget-object v1, p0, Landroid/support/v4/widget/ah;->s:Landroid/view/View;

    invoke-virtual {v0, v1, p1, p2}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;FF)V
...
.method private a(FFII)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    invoke-virtual {v2, p4}, Landroid/support/v4/widget/ah$a;->b(I)Z
...
.method private a(IIII)Z
    ...
    .line 594
    iget-object v1, p0, Landroid/support/v4/widget/ah;->q:Landroid/support/v4/widget/x;
    ...
    .line 600
    iget-object v4, p0, Landroid/support/v4/widget/ah;->q:Landroid/support/v4/widget/x;
...
.method private a(Landroid/view/View;FF)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/ah$a;->b(Landroid/view/View;)I
    ...
    .line 1300
    :goto_1
    iget-object v3, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;)I
...
.method private b(FFI)V
    ...
    .line 1264
    iget-object v1, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    invoke-virtual {v1, v0, p3}, Landroid/support/v4/widget/ah$a;->b(II)V
...
.method private b(IIII)V
    ...
    invoke-virtual {v2, v3, p1, p3}, Landroid/support/v4/widget/ah$a;->b(Landroid/view/View;II)I
    ...
    invoke-virtual {v3, v4, p2, p4}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;II)I
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;IIII)V
...
.method private c(Landroid/view/MotionEvent;)V
    ...
    .line 850
    invoke-direct {p0, v2}, Landroid/support/v4/widget/ah;->g(I)Z
...
.method private e(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/ah;->b(I)Z
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/ah$a;->b(Landroid/view/View;I)V
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    .line 963
    :cond_0
    iget-object v2, p0, Landroid/support/v4/widget/ah;->l:Landroid/view/VelocityTracker;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/ah;->l:Landroid/view/VelocityTracker;
    ...
    .line 973
    invoke-direct {p0, v0, v1, v2}, Landroid/support/v4/widget/ah;->a(FFI)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/widget/ah;->d(II)Landroid/view/View;
    ...
    .line 979
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/widget/ah;->b(Landroid/view/View;I)Z
    ...
    .line 983
    iget v1, p0, Landroid/support/v4/widget/ah;->p:I
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/widget/ah$a;->a(II)V
    ...
    .line 994
    invoke-direct {p0, v2, v1, v0}, Landroid/support/v4/widget/ah;->a(FFI)V
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v4/widget/ah$a;->a(II)V
    ...
    invoke-virtual {p0, v2, v1}, Landroid/support/v4/widget/ah;->d(II)Landroid/view/View;
    ...
    .line 1021
    invoke-direct {p0, v3}, Landroid/support/v4/widget/ah;->g(I)Z
    ...
    invoke-virtual {p0, v0, v4}, Landroid/support/v4/widget/ah;->d(II)Landroid/view/View;
    ...
    invoke-direct {p0, v4, v5, v6}, Landroid/support/v4/widget/ah;->a(Landroid/view/View;FF)Z
    ...
    .line 1038
    iget-object v9, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    float-to-int v10, v5

    invoke-virtual {v9, v4, v8, v10}, Landroid/support/v4/widget/ah$a;->b(Landroid/view/View;II)I
    ...
    .line 1042
    iget-object v11, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    float-to-int v12, v6

    invoke-virtual {v11, v4, v10, v12}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;II)I
    ...
    invoke-virtual {v11, v4}, Landroid/support/v4/widget/ah$a;->b(Landroid/view/View;)I

    move-result v11

    .line 1046
    iget-object v12, p0, Landroid/support/v4/widget/ah;->r:Landroid/support/v4/widget/ah$a;

    invoke-virtual {v12, v4}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;)I
    ...
    .line 1053
    :cond_a
    invoke-direct {p0, v5, v6, v3}, Landroid/support/v4/widget/ah;->b(FFI)V
    ...
    invoke-virtual {p0, v4, v3}, Landroid/support/v4/widget/ah;->b(Landroid/view/View;I)Z
    ...
    .line 1069
    invoke-direct {p0, v0}, Landroid/support/v4/widget/ah;->e(I)V
...
.method public a(Landroid/view/View;II)Z
    ...
    iput-object v1, p0, Landroid/support/v4/widget/ah;->s:Landroid/view/View;
...
.method public a(Z)Z
    ...
    .line 726
    iget-object v0, p0, Landroid/support/v4/widget/ah;->q:Landroid/support/v4/widget/x;
...
.method public b(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/widget/ah;->g(I)Z
...
.method b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v4/widget/ah$a;->a(Landroid/view/View;I)Z
...
.method c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/ah$a;->a(I)V
...
.method public d(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/ah$a;->c(I)I
...
.method public e()V
    ...
    .line 502
    invoke-direct {p0}, Landroid/support/v4/widget/ah;->f()V
