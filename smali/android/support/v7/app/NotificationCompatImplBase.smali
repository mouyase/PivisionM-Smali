...
.method public static applyStandardTemplateWithActions(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZLjava/util/ArrayList;)Landroid/widget/RemoteViews;
    ...
    check-cast v1, Landroid/support/v4/b/an$a;

    invoke-static {p0, v1}, Landroid/support/v7/app/NotificationCompatImplBase;->generateActionButton(Landroid/content/Context;Landroid/support/v4/b/an$a;)Landroid/widget/RemoteViews;
...
.method private static generateActionButton(Landroid/content/Context;Landroid/support/v4/b/an$a;)Landroid/widget/RemoteViews;
    .locals 6

    .prologue
    .line 231
    iget-object v0, p1, Landroid/support/v4/b/an$a;->d:Landroid/app/PendingIntent;
    ...
    .line 236
    invoke-virtual {p1}, Landroid/support/v4/b/an$a;->a()I
    ...
    iget-object v3, p1, Landroid/support/v4/b/an$a;->c:Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Landroid/support/v4/b/an$a;->d:Landroid/app/PendingIntent;
    ...
    iget-object v1, p1, Landroid/support/v4/b/an$a;->c:Ljava/lang/CharSequence;
...
.method private static generateContentViewMedia(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    check-cast v2, Landroid/support/v4/b/ar$a;

    .line 106
    move-object/from16 v0, p0

    invoke-static {v0, v2}, Landroid/support/v7/app/NotificationCompatImplBase;->generateMediaActionButton(Landroid/content/Context;Landroid/support/v4/b/ar$a;)Landroid/widget/RemoteViews;
...
.method private static generateMediaActionButton(Landroid/content/Context;Landroid/support/v4/b/ar$a;)Landroid/widget/RemoteViews;
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation
...
.method public static overrideContentViewMedia(Landroid/support/v4/b/am;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation
