...
# instance fields
.field private final boundary:La/f;
...
.method constructor <init>(La/f;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 75
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:La/f;
...
.method private writeOrCountBytes(La/d;Z)J
    ...
    .line 138
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:La/f;
    ...
    .line 160
    invoke-interface {v0, v8, v9}, La/d;->n(J)La/d;
    ...
    .line 173
    :cond_5
    invoke-virtual {v7, p1}, Lokhttp3/RequestBody;->writeTo(La/d;)V
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(La/d;Z)J
...
.method public writeTo(La/d;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(La/d;Z)J
