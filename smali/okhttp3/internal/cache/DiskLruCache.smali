...
.method private newJournalWriter()La/d;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)La/r;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;La/r;)V
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)La/s;
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()La/d;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:La/d;
    :try_end_3
...
.method public declared-synchronized close()V
    ...
    .line 677
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:La/d;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    invoke-virtual {v2, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(La/d;)V
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 486
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:La/d;
    ...
    invoke-interface {v2, v3}, La/d;->i(I)La/d;

    move-result-object v2

    invoke-interface {v2, p1}, La/d;->b(Ljava/lang/String;)La/d;
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 447
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:La/d;

    const-string v2, "READ"

    invoke-interface {v1, v2}, La/d;->b(Ljava/lang/String;)La/d;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, La/d;->i(I)La/d;

    move-result-object v1

    invoke-interface {v1, p1}, La/d;->b(Ljava/lang/String;)La/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)La/r;
    ...
    invoke-interface {v1, v0}, La/d;->b(Ljava/lang/String;)La/d;
    ...
    invoke-interface {v1, v2, v3}, La/d;->n(J)La/d;
    ...
    invoke-interface {v1, v0}, La/d;->i(I)La/d;
    ...
    invoke-interface {v1, v3}, La/d;->b(Ljava/lang/String;)La/d;

    move-result-object v3

    const/16 v4, 0x20

    invoke-interface {v3, v4}, La/d;->i(I)La/d;
    ...
    .line 412
    invoke-virtual {v0, v1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(La/d;)V
