...
.field final sink:La/d;

.field final source:La/e;
...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;La/e;La/d;)V
    .locals 1
    ...
    .line 91
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:La/e;

    .line 92
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:La/d;

    .line 93
    return-void
.end method

.method private getTransferStream(Lokhttp3/Response;)La/s;
    .locals 4
    ...
    invoke-virtual {p0, v0, v1}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)La/s;
    ...
    invoke-virtual {p0, v0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)La/s;
    ...
    .line 153
    :cond_2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()La/s;
...
.method public createRequestBody(Lokhttp3/Request;J)La/r;
    ...
    .line 98
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()La/r;
    ...
    .line 103
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)La/r;
...
.method public finishRequest()V
    ...
    .prologue
    .line 166
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:La/d;
...
.method public newChunkedSink()La/r;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)La/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)La/r;
    .locals 3
...
.method public newFixedLengthSource(J)La/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()La/s;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .prologue
    .line 132
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->getTransferStream(Lokhttp3/Response;)La/s;
...
.method public readHeaders()Lokhttp3/Headers;
    ...
    .line 215
    :goto_0
    iget-object v1, p0, Lokhttp3/internal/http1/Http1Codec;->source:La/e;

    invoke-interface {v1}, La/e;->s()Ljava/lang/String;
...
.method public readResponseHeaders(Z)Lokhttp3/Response$Builder;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:La/e;

    invoke-interface {v0}, La/e;->s()Ljava/lang/String;
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 174
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:La/d;
