...
# static fields
.field private static final CONNECTION:La/f;

.field private static final ENCODING:La/f;

.field private static final HOST:La/f;
...
.field private static final KEEP_ALIVE:La/f;

.field private static final PROXY_CONNECTION:La/f;

.field private static final TE:La/f;

.field private static final TRANSFER_ENCODING:La/f;

.field private static final UPGRADE:La/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->CONNECTION:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->HOST:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->KEEP_ALIVE:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->PROXY_CONNECTION:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->TRANSFER_ENCODING:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->TE:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->ENCODING:La/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->UPGRADE:La/f;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->CONNECTION:La/f;

    aput-object v1, v0, v3

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->HOST:La/f;

    aput-object v1, v0, v4

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->KEEP_ALIVE:La/f;

    aput-object v1, v0, v5

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->PROXY_CONNECTION:La/f;

    aput-object v1, v0, v6

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->TE:La/f;

    aput-object v1, v0, v7

    const/4 v1, 0x5

    sget-object v2, Lokhttp3/internal/http2/Http2Codec;->TRANSFER_ENCODING:La/f;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, Lokhttp3/internal/http2/Http2Codec;->ENCODING:La/f;

    aput-object v2, v0, v1

    const/4 v1, 0x7

    sget-object v2, Lokhttp3/internal/http2/Http2Codec;->UPGRADE:La/f;

    aput-object v2, v0, v1

    const/16 v1, 0x8

    sget-object v2, Lokhttp3/internal/http2/Header;->TARGET_METHOD:La/f;

    aput-object v2, v0, v1

    const/16 v1, 0x9

    sget-object v2, Lokhttp3/internal/http2/Header;->TARGET_PATH:La/f;

    aput-object v2, v0, v1

    const/16 v1, 0xa

    sget-object v2, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:La/f;

    aput-object v2, v0, v1

    const/16 v1, 0xb

    sget-object v2, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:La/f;
...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:La/f;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v0, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(La/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:La/f;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:La/f;

    invoke-direct {v3, v4, v0}, Lokhttp3/internal/http2/Header;-><init>(La/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:La/f;
    ...
    invoke-direct {v5, v4, v6}, Lokhttp3/internal/http2/Header;-><init>(La/f;Ljava/lang/String;)V
...
.method public static readHttp2HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    .line 166
    :cond_0
    iget-object v6, v0, Lokhttp3/internal/http2/Header;->name:La/f;

    .line 167
    iget-object v0, v0, Lokhttp3/internal/http2/Header;->value:La/f;
    ...
    .line 168
    sget-object v7, Lokhttp3/internal/http2/Header;->RESPONSE_STATUS:La/f;
...
.method public createRequestBody(Lokhttp3/Request;J)La/r;
    .locals 1
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()La/r;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Http2Stream;->getSource()La/s;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;La/s;)V
    ...
    invoke-direct {v1, v2, v0}, Lokhttp3/internal/http/RealResponseBody;-><init>(Lokhttp3/Headers;La/e;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()La/t;
    ...
    invoke-virtual {v0, v2, v3, v1}, La/t;->timeout(JLjava/util/concurrent/TimeUnit;)La/t;

    .line 108
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()La/t;
