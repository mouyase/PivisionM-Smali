...
.method constructor <init>(La/e;Z)V
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(La/e;)V
    ...
    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILa/s;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;
    ...
    .line 214
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;

    invoke-interface {p1, v2, p4, v3, v1}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILa/e;I)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v0, v4, v5}, La/e;->d(J)La/f;

    move-result-object v0

    .line 330
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;La/f;)V
...
.method static readMedium(La/e;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 309
    :cond_1
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 258
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/e;

    invoke-interface {v4}, La/e;->k()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v2}, Lokhttp3/internal/http2/Http2Reader;->readMedium(La/e;)I
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {v0, v2, v3}, La/e;->d(J)La/f;
