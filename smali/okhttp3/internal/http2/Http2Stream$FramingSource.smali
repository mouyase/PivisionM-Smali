...
.field private final readBuffer:La/c;

.field private final receiveBuffer:La/c;
...
.method constructor <init>(Lokhttp3/internal/http2/Http2Stream;J)V
    ...
    iput-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:La/c;
    ...
    iput-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:La/c;
...
.method private waitUntilReadable()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:La/c;
...
.method public read(La/c;J)J
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:La/c;
    ...
    invoke-virtual {v0, p1, v4, v5}, La/c;->read(La/c;J)J
...
.method receive(La/e;J)V
    ...
    .line 410
    :goto_0
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:La/c;

    iget-object v5, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:La/c;
    ...
    .line 391
    invoke-interface {p1, p2, p3}, La/e;->i(J)V
    ...
    .line 403
    :cond_6
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:La/c;

    invoke-interface {p1, v0, p2, p3}, La/e;->read(La/c;J)J
