...
.field private final hpackBuffer:La/c;

.field final hpackWriter:Lokhttp3/internal/http2/Hpack$Writer;

.field private maxFrameSize:I

.field private final sink:La/d;
...
.method constructor <init>(La/d;Z)V
    ...
    .line 58
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:La/d;
    ...
    iput-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:La/c;

    .line 61
    new-instance v0, Lokhttp3/internal/http2/Hpack$Writer;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:La/c;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(La/c;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 293
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:La/d;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:La/c;

    int-to-long v4, v1

    invoke-interface {v0, v2, v4, v5}, La/d;->write(La/c;J)V
...
.method private static writeMedium(La/d;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public declared-synchronized connectionPreface()V
    ...
    sget-object v4, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:La/f;

    invoke-virtual {v4}, La/f;->f()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:La/f;

    invoke-virtual {v1}, La/f;->i()[B
...
.method public declared-synchronized data(ZILa/c;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLa/c;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method dataFrame(IBLa/c;I)V
    ...
    invoke-interface {v0, p3, v2, v3}, La/d;->write(La/c;J)V
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(La/d;I)V
...
.method headers(ZILjava/util/List;)V
    ...
    .line 301
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:La/c;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:La/c;

    int-to-long v6, v1

    invoke-interface {v0, v4, v6, v7}, La/d;->write(La/c;J)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 200
    :goto_2
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:La/d;
