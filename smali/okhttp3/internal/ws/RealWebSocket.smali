...
.method private declared-synchronized send(La/f;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILa/f;)V
...
.method checkResponse(Lokhttp3/Response;)V
    ...
    invoke-static {v1}, La/f;->a(Ljava/lang/String;)La/f;

    move-result-object v1

    .line 233
    invoke-virtual {v1}, La/f;->d()La/f;
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v3, p1, v1, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILa/f;J)V
...
.method public initReaderAndWriter(Ljava/lang/String;JLokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p4, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:La/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLa/d;Ljava/util/Random;)V
    ...
    iget-object v2, p4, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:La/e;

    invoke-direct {v0, v1, v2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLa/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(La/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;La/f;)V
...
.method public declared-synchronized onReadPing(La/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(La/f;)V
    .locals 1
...
.method declared-synchronized pong(La/f;)Z
    .locals 1
...
.method public send(La/f;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(La/f;I)Z
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/ws/RealWebSocket;->send(La/f;I)Z
...
.method writeOneFrame()Z
    ...
    .line 477
    :try_start_1
    invoke-virtual {v9, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(La/f;)V
    :try_end_1
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:La/f;
    ...
    .line 481
    invoke-virtual {v9, v3, v6, v7}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)La/r;
    ...
    .line 483
    invoke-interface {v3, v2}, La/d;->b(La/f;)La/d;

    .line 484
    invoke-interface {v3}, La/d;->close()V
    ...
    iget-object v3, v3, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:La/f;

    invoke-virtual {v9, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILa/f;)V
...
.method writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(La/f;)V
    :try_end_1
