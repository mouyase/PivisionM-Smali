...
.method constructor <init>(ZLa/d;Ljava/util/Random;)V
    .locals 2
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:La/c;
    ...
    .line 68
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:La/d;
...
.method private writeControlFrameSynchronized(ILa/f;)V
    .locals 6
    ...
    .line 132
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:La/d;

    invoke-interface {v2, v1}, La/d;->i(I)La/d;
    ...
    .line 137
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:La/d;
    ...
    .line 140
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:La/d;
    ...
    invoke-interface {v1, v0}, La/d;->c([B)La/d;
    ...
    invoke-interface {v0, p2}, La/d;->b(La/f;)La/d;
...
.method writeClose(ILa/f;)V
    ...
    .line 106
    invoke-virtual {v0, p2}, La/c;->a(La/f;)La/c;
    ...
    :try_start_0
    invoke-direct {p0, v1, v0}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrameSynchronized(ILa/f;)V
    :try_end_0
...
.method writeMessageFrameSynchronized(IJZZ)V
    ...
    .line 207
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:La/c;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskBuffer:[B

    invoke-virtual {v1, v2, v6, v0}, La/c;->a([BII)I
    ...
    invoke-interface {v0, v1}, La/d;->h(I)La/d;
    ...
    invoke-interface {v0, p2, p3}, La/d;->o(J)La/d;
    ...
    invoke-interface {v0, v1, v6, v7}, La/d;->c([BII)La/d;
    ...
    invoke-interface {v0, v1, p2, p3}, La/d;->write(La/c;J)V

    .line 217
    :cond_8
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:La/d;

    invoke-interface {v0}, La/d;->e()La/d;
...
.method writePing(La/f;)V
    ...
    :try_start_0
    invoke-direct {p0, v0, p1}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrameSynchronized(ILa/f;)V
